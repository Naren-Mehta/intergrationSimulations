    ...
    <nav class="navbar navbar-inverse navbar-static-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <g:link controller="trafficHome" action="landingPage" class="navbar-brand">Simulate Traffic Study</g:link>
            </div>

            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li><g:link controller="trafficHome" action="landingPage" class="active">Home</g:link></li>
